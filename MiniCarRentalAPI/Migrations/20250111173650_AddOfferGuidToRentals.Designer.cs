...
namespace MiniCarRentalAPI.Migrations
{
    ...
    [Migration("20250111173650_AddOfferGuidToRentals")]
    partial class AddOfferGuidToRentals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharedDataModels.Acceptation", b =>
                {
                    ...
                    b.Property<string>("ImageAzureBlobUri")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SharedDataModels.ApiEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SharedDataModels.Car", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Location", "SharedDataModels.Car.Location#Location", b1 =>
                        {
                            b1.IsRequired();
